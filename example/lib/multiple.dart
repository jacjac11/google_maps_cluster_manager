...
class MapSampleState extends State<MapSample> {
  ...
  @override
  void initState() {
    _manager = CClusterManager<Place>(items, _updateMarkers,
        markerBuilder: _getMarkerBuilder(Colors.red));

    _manager2 = CClusterManager<Place>(items2, _updateMarkers2,
  ...
  Future<Marker> Function(CCluster<Place>) _getMarkerBuilder(Color color) =>
      (cluster) async {
        return Marker(
